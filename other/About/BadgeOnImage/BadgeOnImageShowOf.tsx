...
import BadgeOnImage from "./BadgeOnImage";

export const BadgeOnImageShowOf = () => {
  return (
    <div>
      <BadgeOnImage />
    </div>
...
export const BadgeOnImageCode = `import Image from "next/image";
  ...
  return (
    <div className="flex flex-col justify-center max-w-xl gap-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start justify-start mt-6">
        <Link
          href="/"
          className="flex w-fit px-8 items-center gap-4 p-4 font-semibold text-xl text-white duration-300 transition-transform active:scale-90 relative overflow-hidden group z-20 cursor-pointer"
        >
          Contact Us
