...
import DarkOnHover from "./DarkOnHover";

export const DarkOnHoverShowOf = () => {
  return (
    <div className="flex items-center justify-center w-full p-4 py-12 bg-gray-900">
      <DarkOnHover />
    </div>
  );
};

export const DarkOnHoverCode = `import { FaPerson } from "react-icons/fa6";
