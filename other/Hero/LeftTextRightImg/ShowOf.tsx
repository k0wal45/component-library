...
import TextLeftHero from "./Hero";

export const TextLeftHeroShowOf = () => {
  return (
    <div className="">
      <TextLeftHero />
    </div>
...
export const TextLeftHeroCode = `import Image from "next/image";
import Link from "next/link";

        // remember to insert your image here
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-start lg:max-w-[40vw] p-4 gap-8">
        ...
        <Link
          href=""
          className="p-4 px-6 bg-gradient-to-br from-orange-500 bg-yellow-400 font-semibold text-white duration-200 transition-all hover:scale-105 active:scale-95"
        >
          Take Action
        </Link>
      </div>
