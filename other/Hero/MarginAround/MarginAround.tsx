...
export const MarginAround = () => {
  return (
    <header className="bg-cover h-fit  rounded-3xl flex flex-col lg:flex-row items-end justify-between overflow-hidden bg-fixed bg-[url(https://images.unsplash.com/photo-1505133078601-a8b623c0517b?q=80&w=2129&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
      <section className="flex flex-col gap-12 items-start justify-start lg:w-1/2 p-6 lg:p-24">
        <Reveal>
