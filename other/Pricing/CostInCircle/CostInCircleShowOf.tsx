...
import CostInCircle from "./CostInCircle";

export const CostInCircleShowOf = () => {
  return (
    <div>
      <CostInCircle />
    </div>
...
export const CostInCircleCode = `import { Playfair } from "next/font/google";
...
const CostInCircle = () => {
  return (
    ...
    >
      ...
      <Link
        href=""
        className="px-6 py-4 bg-lime-400 text-xl uppercase rounded-none mt-12 hover:scale-105 active:scale-95 duration-200"
      >
        view full menu
      </Link>
    </section>
