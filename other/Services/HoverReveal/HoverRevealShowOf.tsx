...
export const HoverRevealShowOf = () => {
  return (
    <div>
      <HoverReveal />
    </div>
...
export const HoverRevealCode = `"use client";
...
const HoverReveal = () => {
  return (
    <section
      className=bg-cover lg:bg-contain flex flex-col items-center justift-center gap-8 mx-auto p-4 my-12
    >
